...
const IconChatBubbleElipsesOutline: React.FC<IProps> = ({ className = "", style }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className={`ionicon ${className}`} style={style}>
...
export default IconChatBubbleElipsesOutline;
