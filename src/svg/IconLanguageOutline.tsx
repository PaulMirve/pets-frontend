...
const IconLanguageOutline = ({ className = "", ...rest }: SVGProps<SVGSVGElement>) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" className={`ionicon ${className}`} viewBox="0 0 512 512" {...rest}>
            ...
            <path d="M256 336s-35-27-72-75-56-85-56-85" fill="none" stroke="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="32" />
        </svg>
    )
}

export default IconLanguageOutline
