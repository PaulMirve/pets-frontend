...
const IconLogoutOutline: React.FC<SVGProps<SVGSVGElement>> = ({ ...rest }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" className="ionicon" viewBox="0 0 512 512" {...rest}>
            <title>Log Out</title>
...
export default IconLogoutOutline
